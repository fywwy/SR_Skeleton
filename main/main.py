...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/ntu/train_joint_amstgcn_ntu.yaml',
    ...
    parser.add_argument(
        '--batch-size', type=int, default=8, help='training batch size')    # 默认为256
    parser.add_argument(
        '--test-batch-size', type=int, default=8, help='test batch size')       # 默认为256
    parser.add_argument(
        '--start_epoch',
        type=int,
        default=0,
